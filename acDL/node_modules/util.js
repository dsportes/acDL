...
document.addEventListener('WebComponentsReady', function() {
	AC.fs.readFile("./sorts.json", 'utf-8', function(err, data) {
		if (err)
...
AC.error = function(msg, detail){
	AC.eventEmitter.emit("sbError", {msg:msg, detail:detail});
};
AC.info = function(msg, detail){
	AC.eventEmitter.emit("sbInfo", {msg:msg, detail:detail});
};
AC.progress = function(msg, detail, done, total){
	AC.eventEmitter.emit("sbProgress", {msg:msg, detail:detail, done:done, total:total});
};
